...
export const useDriverLiveRating = (driverId: number, options?: SSEOptions) => {
  ...
  useEffect(() => {
    ...
    try {
      const eventSource = new EventSource(`${apiConfig.baseURL}/driver/${driverId}/live`);
...
export const useDriverBadgesLive = (driverId: number, options?: SSEOptions) => {
  ...
  useEffect(() => {
    ...
    try {
      const eventSource = new EventSource(`${apiConfig.baseURL}/driver/${driverId}/badges/live`);
