...
import { BarChart3, CarFront, Bell, Menu, X, LogOut } from 'lucide-react';
      ...
      <div className="max-w-[1200px] mx-auto h-full px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          {isAuthenticated && currentUser && (
            <button
              onClick={() => navigate(`/driver/${currentUser.id}/stats`)}
              className="relative px-4 py-2 text-sm font-medium transition-colors duration-200 rounded-lg text-covoit-text-secondary hover:text-white hover:bg-white/5 flex items-center gap-2"
            >
              <BarChart3 size={16} />
              Mes stats
            </button>
        ...
        <div className="flex items-center gap-3">
          ...
          {isAuthenticated && (
            <div className="relative hidden sm:flex items-center">
              ...
              {userMenuOpen && (
                <div className="absolute top-full right-0 mt-1 glass-panel rounded-lg shadow-lg min-w-[220px] py-2 z-50">
                  {currentUser && (
                    <button
                      onClick={() => {
                        navigate(`/driver/${currentUser.id}/stats`);
