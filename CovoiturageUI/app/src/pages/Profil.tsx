    ...
    return (
      <div className="max-w-[800px] mx-auto px-6 py-10 animate-fade-in">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-center text-white/80">
          <p>Utilisateur non connecté. Veuillez vous connecter pour accéder à votre profil.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="card-surface p-6">
            ...
            {currentUser && (
              <div className="mb-4 flex gap-2 justify-end">
                <button
                  onClick={() => window.location.href = `/driver/${currentUser.id}/stats`}
                  className="btn-ghost text-sm py-2.5 px-3 flex items-center gap-2"
                >
                  <BarChart3 size={16} />
                  Voir mes stats
                </button>
